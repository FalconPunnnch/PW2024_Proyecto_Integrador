...
const register = async (req, res) => {
    try {
        const { username, nombres, apellidos, email, password, role } = req.body;
        
        if (!username || !nombres || !apellidos || !email || !password || !role) {
...
const updateUser = async (req, res) => {
    try {
        ...
        const fieldsToUpdate = { nombres, apellidos, email, password };
